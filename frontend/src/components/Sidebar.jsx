...
const ENTITY_TYPES = [
  ...
  { value: 'coworking', label: 'Coworking', icon: '💼', color: '#14B8A6' },
  { value: 'investor', label: 'Investors', icon: '💰', color: '#EF4444' },
  { value: 'mentor', label: 'Mentors', icon: '🧠', color: '#8B5CF6' },
  { value: 'corporate', label: 'Corporates', icon: '🏛️', color: '#0EA5E9' },
  { value: 'government_body', label: 'Govt Bodies', icon: '🏛️', color: '#D97706' },
]
